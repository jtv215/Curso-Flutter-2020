...
import 'package:qr/pages/direciones_page.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  void scanQR(BuildContext context) async {
    ...
    if (futureString != null) {
      ...
      final scan =
          ScanModel(valor: futureString); //se ha exportado del model scan_model
      scansBloc.agregarScan(scan);

      // final scan2 = ScanModel(
      //     valor:
      //         'geo:40.66592495825039,-73.9935816808594'); //se ha exportado del model scan_model
